        ...
        <div className='p-3 text-sm text-black bg-alice-blue border-base'>
          <div className='flex justify-between'>
            <div className='box-border w-1/2 p-4'>
              ...
              <p>Velg varigheten på hver runde</p>
              <select name='time' id='timeDropdown' className='p-1 shadow-lg h-7 border-base'>
            ...
            <div className='box-border w-1/2 p-4'>
              ...
              <p>Velg om lag skal velges tilfeldig eller være opp til spillerene</p>
              <input
                type='checkbox'
                id='randomTeamsCheckbox'
                className='shadow-lg h-7 w-7 border-base'
              />
            </div>
          </div>
          <div className='flex justify-between'>
            <div className='box-border w-1/2 p-4'>
              ...
              <p>Velg størrelsen på lag, eller la det styres automatisk av spillet</p>
              <select name='time' id='timeDropdown' className='p-1 shadow-lg h-7 border-base'>
            ...
            <div className='box-border w-1/2 p-4'>
              ...
              <p>Velg om spillerene kan velge rollene sine eller om de skal velges tilfeldig</p>
              <input
                type='checkbox'
