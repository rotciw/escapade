  ...
  return (
    <>
      ...
      <div className='flex flex-row flex-wrap pb-8 mt-8 justify-evenly'>
        ...
        <div className='flex flex-col w-2/6 h-full p-4 px-8 pb-8 text-black rounded bg-alice-blue'>
          <div className='flex flex-col pb-4'>
            <h1 className='mb-2 text-xl font-semibold text-center'>Runde {round + 1}/3</h1>
